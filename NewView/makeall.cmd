...
nv_build_dir_newview = nv_build_dir||'\newview'
nv_rc = SysMkDir( nv_build_dir_newview )

Say 'Building NewView...'
'rcomp20 Images.rc ' nv_build_dir_newview
'spc20 newview.spr'

nv_build_dir_viewstub = nv_build_dir||'\newview_stub'
nv_rc = SysMkDir( nv_build_dir_viewstub )

Say 'Building ViewStub...'
'rcomp20 ViewStub.rc ' nv_build_dir_viewstub
'spc20 viewstub.spr'
...
SetUpPaths: PROCEDURE EXPOSE g.
    ...
    '@SET INCLUDE=%WATCOM%\H;%WATCOM%\H\OS2;' || GetVar('PMPRINTF_PATH')
    '@SET LIB=%PMPRINTF_PATH%;'
